...
/**
 * Driver program that reads in a graph and prompts user for shortests
 * paths in the graph.
 *
 * @author Ka Yee (@uw.edu), Viveret Steele (viveret@uw.edu), Austin (adi1996@uw.edu)
 * @version 2016-03-08, 15:19 PM
 *
 */
public class FindPaths {
	public static void main(String[] args) {
		...
		while(true) {
			...
			System.out.println("Shortest path from " + a.getLabel() + " to " 
                    + b.getLabel() + ":");
			if (p == null || p.vertices.size() < 1) {
